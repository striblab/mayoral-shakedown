...
```html
<div data-pym-src="http://static.startribune.com/projects/mayoral-shakedown">Loading...</div>
...
```js
{
  "publish": {
    "default": {
      ...
      "path": "news/projects-staging/all/mayoral-shakedown/",
      "url": "http://static.startribune.com/news/projects-staging/all/mayoral-shakedown/"
    },
    "production": {
      "bucket": "static.startribune.com",
      "path": "news/projects/all/mayoral-shakedown/",
      "url": "http://static.startribune.com/news/projects/all/mayoral-shakedown/"
    }
  }
}
```
